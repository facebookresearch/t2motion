...
python train.py data=babelsync-ems-mul-amass-rot run_id=super_clean data.batch_size=8 model=ems model.optim.lr=5.0e-05 init_weight=/private/home/yijunq/repos/t2motion/outputs/humor_prior.pt