...
parser.add_argument("--gt_feat_folder", type=str, default="/checkpoint/yijunq/tmp_gt")
parser.add_argument('--feat_folder', type=str, default="/checkpoint/yijunq/tmp_predict")
